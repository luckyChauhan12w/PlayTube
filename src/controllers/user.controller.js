...
const changeCurrentPassword = asyncHandler(async (req, res) => {
    ...
    return res.status(201).json(new ApiResponse(201, req.user, "User password changed successfuly"))
...
const updateUserAvatar = asyncHandler(asyncHandler(async (req, res) => {
...
const updateUserCoverImage = asyncHandler(asyncHandler(async (req, res) => {
    ...
    if (!coverImage) {
        throw new ApiError(400, "coverImage file is not able to upload")
    }
